...
def profiles_command(args):
    ...
    print("\n" + "=" * 60)
    print("  Use: cloakpii migrate --compliance pipl --compliance-report")
    print("=" * 60 + "\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="CloakPII — secure, compliant data migration.",
